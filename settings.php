...
if ($hassiteconfig) {
    ...
    // Link name.
    $settings->add(new admin_setting_configtext('local_parents/link_name', get_string('link_name', 'local_parents'),
            get_string('link_name_desc', 'local_parents'), 'Parents'));
    ...
    $settings->add(new admin_setting_configselect('local_parents/parent_role', get_string('parent_role', 'local_parents'),
            get_string('parent_role_desc', 'local_parents'), $parent, $options));
